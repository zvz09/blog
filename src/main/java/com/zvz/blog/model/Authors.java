...
public class Authors {
	...
	public Authors(String account) {
		this.account = account;
	}

	@Override
	public String toString() {
		return "Authors{" + "id=" + id + ", account='" + account + '\''
				+ ", password='" + password + '\'' + ", userStatus="
				+ userStatus + ", penName='" + penName + '\'' + ", email='"
				+ email + '\'' + ", profile='" + profile + '\''
				+ ", otherInfo='" + otherInfo + '\'' + ", verificationCode='"
